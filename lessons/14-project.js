...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Tutto quello che hai imparato, messo insieme in un flusso completo. La vera abilita nel ML non e conoscere gli algoritmi a memoria, ma sapere come combinarli, valutarli onestamente e comunicare i risultati in modo utile." },
