...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "NumPy e Pandas sono i tuoi attrezzi quotidiani. NumPy gestisce calcoli veloci su grandi array di numeri, Pandas gestisce tabelle con righe e colonne come un foglio Excel programmabile. Senza di loro, ogni operazione richiederebbe loop lentissimi." },
