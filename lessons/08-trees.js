...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Impara a classificare facendo domande si/no in sequenza, come un gioco a indovinare. Random Forest fa la stessa cosa con centinaia di alberi che votano insieme: tanti modelli mediocri che si correggono diventano un modello molto robusto." },
