...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Trova il confine tra le classi che e il piu lontano possibile da entrambe. Come separare due gruppi con una linea tenendola il piu distante da tutti. Con il kernel trick funziona anche per separazioni non lineari complesse." },
