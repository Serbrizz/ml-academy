...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Prima di costruire un motore bisogna capire fisica e meccanica. Questi sono gli strumenti matematici del ML: vettori, derivate, probabilita. Li hai gia visti in fisica; qui li usiamo per ottimizzare modelli invece di descrivere il moto." },
