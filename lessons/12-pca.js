...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Se hai 50 variabili ma molte sono correlate, PCA le comprime nelle direzioni che contengono piu informazione. Come fotografare un oggetto 3D dalla prospettiva migliore: perdi una dimensione ma catturi l'essenziale." },
