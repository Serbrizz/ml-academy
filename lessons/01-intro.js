...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Invece di scrivere regole a mano, mostri esempi al computer e lui trova le regole da solo. Come insegnare a un bambino: non gli spieghi la grammatica, gli fai leggere tante frasi finche non la capisce da solo." },
