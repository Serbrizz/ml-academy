...
window.LESSONS.push({
  ...
  "teoria": [
    { type: 'callout', variant: 'tip', title: "L'idea in breve", content: "Come la regressione lineare, ma per rispondere a domande si/no: e spam? E maligno? Fara click? Invece di una retta usa una curva a S che schiaccia tutto tra 0 e 1, interpretabile direttamente come probabilita." },
